      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <a href="{{url('/pengetahuan/create')}}" class="btn btn-primary rounded-0">Tambah data pengetahuan</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tr>
                ...
                <td>{{$row->cf}}</td>
                <td>
                  <form action="{{url("/pengetahuan/$row->id")}}" method="POST" class="flex gap-2">
                    @method('delete')
                    @csrf
                    <a href="{{url('/pengetahuan/edit/'.$row->id)}}" class="btn btn-primary btn-sm rounded-0"><i class="fas fa-edit"></i></a>
