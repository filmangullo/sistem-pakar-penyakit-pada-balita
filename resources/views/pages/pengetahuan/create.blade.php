...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tambah Data Pengetahuan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('/')}}">Beranda</a></li>
            <li class="breadcrumb-item active"><a href="{{url('/pengetahuan')}}">Pengetahuan</a></li>
            <li class="breadcrumb-item active"><a href="{{url('/pengetahuan/create')}}">Tambah Data</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <form action="{{url('/pengetahuan')}}" method="POST">
            ...
            <div class="card-body">
              ...
              {{-- <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control" name="mb" id="mb" placeholder="Masukkan nilai MB" required>
              </div>
              <div class="form-group">
                <label for="md">MD</label>
                <input type="number" step="0.01" class="form-control" name="md" id="md" placeholder="Masukkan nilai MD" required>
              </div> --}}
              <div class="form-group">
                <label for="cf">CF</label>
                <input type="number" step="0.01" class="form-control" name="cf" id="cf" placeholder="Masukkan nilai CF" required>
              </div>
            </div>
            <!-- /.card-body -->
